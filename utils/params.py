...
def get_parser():
    ...
    # basic config
    parser.add_argument('--grid_size', type=tuple_type, default=(16, 16), 
    ...
    # data loader
    parser.add_argument('--root_path', type=str, default='./data/data.csv', 
    ...
    parser.add_argument('--target', type=str, nargs='+', default=['t2m'], 
                        help='target feature in S or MS task')
    parser.add_argument('--freq', type=str, default='h',
                        help='freq for time features encoding, options:[s:secondly, t:minutely, h:hourly, d:daily, b:business days, w:weekly, m:monthly], you can also use more detailed freq like 15min or 3h')
    parser.add_argument('--checkpoints', type=str, default='./checkpoints/', 
                        help='location of model checkpoints')
    parser.add_argument('--use_multi_heads', type=int, default=0, 
                        help='number of used feature heads')
    ...
    # model define - ConvLSTM parameters
    ...
    parser.add_argument('--bias', action='store_true', 
                        help='whether to use bias in ConvLSTM layers', default=False)
    ...
    # SwinLSTM parameters
    parser.add_argument('--input_img_size', default=16, type=int, 
    ...
    parser.add_argument('--depths', default=[2], type=int, 
                        help='Depth of Swin Transformer layer for SwinLSTM-B')
    parser.add_argument('--depths_down', default=[2, 6], type=int, 
                        help='Downsample of SwinLSTM-D')
    parser.add_argument('--depths_up', default=[6, 2], type=int, 
                        help='Upsample of SwinLSTM-D')
    ...
    parser.add_argument('--window_size', default=2, type=int, 
                        help='Window size of Swin Transformer layer')
